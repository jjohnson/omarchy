...
actual_aarch64=$(OMARCHY_PATH="$ROOT" "$ROOT/bin/omarchy-pkg-base-list" aarch64 "$manifest")
[[ $actual_aarch64 == $expected_aarch64 ]] ||
  fail "aarch64 base packages use the repository binfmt provider" "$actual_aarch64"
